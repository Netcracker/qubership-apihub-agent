...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.5.8 // indirect
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.5.3 // indirect
	github.com/netcracker/qubership-core-lib-go/v3 v3.9.1 // indirect
