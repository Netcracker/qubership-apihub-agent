...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.5.0 // indirect
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.4.0 // indirect
