...
require (
	...
	github.com/netcracker/qubership-core-lib-go-paas-mediation-client/v8 v8.5.1
...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.5.1 // indirect
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.4.1 // indirect
